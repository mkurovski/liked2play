...
Welcome to ``liked2play`` contributor's guide.
...
If you experience bugs or general issues with ``liked2play``, please have a look
...
You can help improve ``liked2play`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``liked2play`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``liked2play``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n liked2play python=3 six virtualenv pytest pytest-cov
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/liked2play.git
    cd liked2play
...
#. Install |pre-commit|_::
   ...
   ``liked2play`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/liked2play
.. _issue tracker: https://github.com/<USERNAME>/liked2play/issues
.. <-- end -->
